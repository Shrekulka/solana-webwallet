...
from services.wallet_service import get_transaction_history_from_db, save_transaction
    ...
    try:
        ...
        while transaction_max_limit > 0:
            ...
            if "api.devnet.solana.com" not in SOLANA_NODE_URL:
                ...
                transaction_history += await get_transaction_history(wallet_address, transaction_id_before,
                                                                     transaction_limit)
            ...
            if transaction_history:
                ...
                if transaction_history[-1].block_time in tr_from_db_time_list:
                    ...
                    if (el_index + 1) < len(tr_history_from_db):
                        tr_from_db_tasks = [format_transaction_from_db_message(tr) for tr in
                                            tr_history_from_db[el_index + 1:]]
                    break
