...
from external_services.solana.solana import is_valid_wallet_address, http_client, get_transaction_history
...
@transaction_router.callback_query(F.data.startswith("wallet_address:"), StateFilter(FSMWallet.choose_transaction_wallet))
