...
async def get_transaction_wallet_keyboard(user_wallets: List[SolanaWallet]) -> InlineKeyboardMarkup:
    """
    ...
    for i, wallet in enumerate(user_wallets):
        ...
        wallet_info = LEXICON["wallet_transaction_info_template"].format(
            number=i + 1,
            name=wallet.name,
